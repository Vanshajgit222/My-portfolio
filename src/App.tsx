...
import { Mail, Phone, Linkedin, ExternalLink, Award, GraduationCap, Briefcase, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <Section title="Skills" id="skills">
        <p className="text-gray-300 mb-8">Click on each category to explore my technical skills and expertise</p>
        <SkillsSection />
      </Section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <div className="bg-gradient-to-r from-yellow-600 to-orange-600 p-4 rounded-lg mb-6">
              ...
              <a 
                href="https://drive.google.com/file/d/1-_boFn33ZuwzA1euN9CT1njHKiiEsG9C/view?usp=sharing"
                target="_blank"
      ...
      <Section title="Connect with me!" id="contact">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <a 
            href="https://www.linkedin.com/in/vanshaj-kumar-singh-1753b4255/" 
            target="_blank"
            rel="noopener noreferrer"
            className="bg-blue-600 hover:bg-blue-700 p-4 rounded-lg transition-colors flex items-center space-x-3"
          >
